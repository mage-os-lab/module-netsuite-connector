 ...
 */
class Cybersourcetokenized implements ProcessorInterface
{
    /**
     * {@inheritdoc}
     */
    public function addProcessorSpecificInformationToNetSuiteOrder(
        ...
        $netsuiteOrder->authCode = $paymentObject->getAdditionalInformation('magedelight_cybersource_subscription_id');
        $netsuiteOrder->ccNumber = $paymentObject->getAdditionalInformation('magedelight_cybersource_subscription_id');
