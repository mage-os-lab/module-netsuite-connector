...
class CreditMemoTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRecordWithoutOrderId()
    {
        ...
        $creditMemo = NSRecordBuilder::aRecord(\NetSuite\Classes\CreditMemo::class)
            ->withInternalId(1001)
            ->build();

        /** @var \MageOS\NetSuiteConnector\Refund\Model\Process\Import\Creditmemo $creditMemoImport */
        $creditMemoImport = $this->objectManager->get(\MageOS\NetSuiteConnector\Refund\Model\Process\Import\CreditMemo::class);
