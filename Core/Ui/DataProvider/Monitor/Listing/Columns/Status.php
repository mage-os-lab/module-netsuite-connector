...
use MageOS\NetSuiteConnector\Core\Model\Monitor\Data\Status as ItemStatus;
...
class Status extends Column implements OptionSourceInterface
{
    public function prepareDataSource(array $dataSource)
    {
        ...
        foreach ($dataSource['data']['items'] as &$item) {
            if (isset($options[$item['status_original']])) {
                $item['status'] = $options[$item['status_original']];
            }
        }
