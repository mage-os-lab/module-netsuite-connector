...
$customer->setWebsiteId(1)
    ->setId(2)
    ->setEmail('customer-wholesale@rocketweb.com')
    ->setPassword('password')
    ->setGroupId(2)
    ->setStoreId(1)
    ->setIsActive(1)
...
$fixtureCreator
    ...
    ->scheduleDeletion(\NetSuite\Classes\RecordType::customer, null, 'customer-wholesale@rocketweb.com_1');
