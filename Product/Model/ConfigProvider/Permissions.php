...
namespace MageOS\NetSuiteConnector\Product\Model\ConfigProvider;

/**
 * This class checks if Getting Products from NetSuite is enabled
 */
class Permissions implements \MageOS\NetSuiteConnector\Core\Model\Config\PermissionsConfigInterface
{
    ...
    {
        if ($featureCode != self::GET_PRODUCTS) {
            return false;
        }
