...
class OrderPlaceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function setUpBeforeClass():void
    {
        $fixturesUsed = [
            ...
            '_files/order_with_multiple_discount.php',
     ...
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/quote.php
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/order_with_discount.php
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/submit_order_to_ns_queue.php
     ...
     * @magentoConfigFixture default/mageos_netsuite/orders/add_promotion_data 0
     * @magentoDbIsolation enabled
     * @magentoAppIsolation enabled
     */
    public function testOrderWithLineDiscount()
    {
        ...
        $expectedAddRequest = $this->getRequest('OrderLineDiscount-new');
        unset(
     ...
     * @magentoConfigFixture default/mageos_netsuite/orders/discount_item_id 9
     * @magentoConfigFixture default/mageos_netsuite/orders/add_promotion_data 0
     * @magentoDbIsolation enabled
     * @magentoAppIsolation enabled
     */
    public function testOrderWithBodyDiscount()
    {
        \Magento\TestFramework\Helper\Bootstrap::getInstance()
            ->loadArea(\Magento\Framework\App\Area::AREA_FRONTEND);
        ...
        $expectedAddRequest = $this->getRequest('OrderBodyDiscount-new');
        unset(
            $addRequest->record->tranDate,
            $expectedAddRequest->record->tranDate,
            $addRequest->record->shippingTaxCode,
     ...
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/customer.php
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/quote.php
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/order_with_multiple_discount.php
     * @magentoDataFixture ../../../../app/code/MageOS/NetSuiteConnector/Discount/Test/Integration/_files/submit_order_to_ns_queue.php
     * @magentoConfigFixture default/mageos_netsuite/payment_methods/netsuite_mapping [{"payment_method":"checkmo","payment_cc":"","internal_netsuite_id":"1"}]
     * @magentoConfigFixture default/mageos_netsuite/shipping_methods/netsuite_default_shipping_id 2
     * @magentoConfigFixture default/mageos_netsuite/shipping_methods/netsuite_mapping {"_1598626367813_813":{"shipping_method":"flatrate_flatrate","shipping_description":"","internal_netsuite_id":"2"}}
     ...
     * @magentoAppIsolation enabled
     */
    public function testOrderWithPromotionData()
    {
        \Magento\TestFramework\Helper\Bootstrap::getInstance()
            ->loadArea(\Magento\Framework\App\Area::AREA_FRONTEND);
        ...
        $expectedAddRequest = $this->getRequest('OrderBodyDiscountWithPromotionData-new');
        unset(
            $addRequest->record->tranDate,
            $expectedAddRequest->record->tranDate,
            $addRequest->record->shippingTaxCode,
