...
$orderStatusMap = [
    [
        'netsuite_status' => 'Closed',
        'magento_status' => 'closed'
    ],
    [
        'netsuite_status' => 'Pending Approval',
        'magento_status' => 'processing'
    ],
    [
        'netsuite_status' => 'Pending Fulfillment',
        'magento_status' => 'processing'
    ],
    [
        'netsuite_status' => 'Partially Fulfilled',
        'magento_status' => 'processing'
    ],
    [
        'netsuite_status' => 'Pending Billing',
        'magento_status' => 'processing'
    ],
    [
        'netsuite_status' => 'Billed',
        'magento_status' => 'complete'
    ],
    [
        'netsuite_status' => 'Canceled',
        'magento_status' => 'canceled'
    ]
];
...
$configMap = [
    ...
    ['mageos_netsuite/products/field_map', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, json_encode($fieldMap)],
    ...
    ['mageos_netsuite/products/related_products_field', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, 'custitem_related'],
    ['mageos_netsuite/products/upsells_field', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, 'custitem_upsells'],
    ['mageos_netsuite/shipping_methods/netsuite_mapping', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, json_encode($shipping_map)],
    ['mageos_netsuite/payment_methods/netsuite_mapping', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, json_encode($payment_map)],
    ['mageos_netsuite/orders/status_map', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, json_encode($orderStatusMap)],
    ['mageos_netsuite/shipping_methods/netsuite_default_shipping_id', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, '1'],
    ['mageos_netsuite/customers_import/import_customers_store', ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, '1'],

    ['cataloginventory/item_options/backorders',ScopeConfigInterface::SCOPE_TYPE_DEFAULT, null, '1'],
];
